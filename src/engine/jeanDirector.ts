...
export const dialogueLibrary: Record<JeanMode, JeanLine[]> = {
  ...
  tempo: [...make(['Bring the pressure up one step.','Hold threshold without forcing the gear.','Keep this honest and repeatable.','Work starts again. Find the rhythm.','Strong tempo; stay inside yourself.','Close the gap steadily, not in one hit.','Take your turn, then slide back into shelter.','This is race pressure. Stay composed.','Keep cadence alive as resistance rises.','Hold it here; do not drift upward.'], 'instruction', 'tempo'), ...make(['The move is stretching the group.','Good response. You are still in control.'], 'observation', 'attack')],
