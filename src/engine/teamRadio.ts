...
export type TeamRadioMessage={id:string;text:string;priority:RadioPriority;createdAt:string;requiresAnswer?:boolean;coachingContext?:string;activityKey?:string}
