...
import { createDevelopmentProfile, emptyAlpha4025, generatePlan, HAL_BASELINE, HAL_GOALS, HAL_INPUT, recommendCamps } from '../engine/alpha4025.ts'
...
export function createInitialCareer():CareerState{return {
 ...
 season:{year:2026,currentRace:'Tour de France',currentStage:1,completedStages:[1,2],closure:activeSeasonClosure()},pastSeasons:[],favoriteStageRefs:[],races:{tour:{currentStage:1,completedStages:[1,2]},vuelta:{currentStage:1,completedStages:[]}},trainingHistory:[],
