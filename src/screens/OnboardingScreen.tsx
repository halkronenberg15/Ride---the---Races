...
const connectionChoices:Array<{id:ConnectionMethod;label:string;status:string;description:string}>=[
  {id:'manual-guidance',label:'Manual guidance',status:'Available now',description:'Follow RtR targets and adjust the bike yourself.'},
  {id:'post-ride-import',label:'Post-ride import',status:'Available now',description:'Record elsewhere and import the completed activity afterward.'},
]
